...
const int inf = 0x3f3f3f3f, mod = 1e9 + 7, maxn = 1e3 + 5, maxa = 1e4 + 5;
const long long INFL = 0x3f3f3f3f3f3f3f3f;
modnum<mod> dp[maxn][2 * maxa + 5];
...
void solve() {
    ...
    dp[0][maxa + a[0]] = dp[0][maxa - a[0]] = 1;
    modnum<mod> sol = 0;
    for (int i = 1; i < n; ++i) {
        dp[i][maxa + a[i]] = dp[i][maxa - a[i]] = 1;
