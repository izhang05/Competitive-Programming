...
//    friend pairnum operator/(const pairnum &a, const pairnum &b) { return pairnum(a) /= b; }
//};
//const int inf = 0x3f3f3f3f, mod = 998244353, maxb = 31;
...
//    vector<vector<int>> b(n, vector<int>(maxb));
//    for (int i = 0; i < n; ++i) {
//        cin >> a[i];
...
//            if (i != maxb - 1) {
//                if (first) {
//                    sol += 2 * one * (one + zero); // a_i = 1, b_i = anything
//                } else {
//                    sol += 2 * one * one;
//                }
//                sol += zero * one; // a_i = 0, b_i = 1 -> implies a < b
//                if (!v_o.empty()) {
//                    nxt.push_back(v_o);
//                }
//                if (!v_z.empty()) {
